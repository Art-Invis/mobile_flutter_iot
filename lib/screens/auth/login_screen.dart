...
import 'package:mobile_flutter_iot/cubits/flashlight_cubit.dart';
...
class LoginScreen extends StatelessWidget {
      ...
      child: Scaffold(
        body: MultiBlocListener(
          listeners: [
            ...
            BlocListener<FlashlightCubit, FlashlightState>(
              listener: (context, state) {
                if (state.errorMessage == 'UNSUPPORTED_PLATFORM') {
            ...
            builder: (context, authState) {
              ...
              return BlocBuilder<FlashlightCubit, FlashlightState>(
                builder: (context, flashState) {
                  return Stack(
                    children: [
                      OverrideBackground(isOverrideActive: flashState.isOn),
                      SafeArea(
                        child: Center(
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                GestureDetector(
                                  onTap: () => context
                                      .read<FlashlightCubit>()
                                      .handleSecretTap(),
                                  child: _buildLogo(flashState.isOn),
                                ),
  ...
  Widget _buildLogo(bool isOverrideActive) {
    return Container(
      ...
      child: Icon(
        Icons.hub_outlined,
        size: 60,
        color: isOverrideActive ? Colors.redAccent : const Color(0xFF38BDF8),
      ),
    );
  }
}
