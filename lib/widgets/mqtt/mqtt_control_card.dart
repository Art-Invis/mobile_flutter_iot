...
//   bool _isTimeRestricted(int start, int end) {
...
//     final bool isLocked =
//         _isTimeRestricted(mqttState.startLockHour, mqttState.endLockHour);
//     final String lockTimeStr =
//         '${mqttState.startLockHour.toString().padLeft(2, '0')}:00 - '
//         '${mqttState.endLockHour.toString().padLeft(2, '0')}:00';
...
//             onChanged: (bool value) {
//               if (isLocked) {
//                mqttBloc.add(MqttToggleHardwareRequested(!mqttState.isLedOn));
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   const SnackBar(
//                    content: Text('ACCESS DENIED: System lock policy active'),
//                     backgroundColor: Colors.redAccent,
